...
const EggIcon: React.FC<IconProps> = ({ onClick, disabled, className }) => {
  ...
  const width = isLgUp ? '31' : isMdUp ? '29' : isSmUp ? '27' : '24.68';
  const height = isLgUp ? '40' : isMdUp ? '37' : isSmUp ? '34' : '31.88';
  ...
  return (
    ...
    >
      <svg width={width} height={height} viewBox="0 0 31 40" fill="none" xmlns="http://www.w3.org/2000/svg">
